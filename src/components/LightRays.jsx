...
const LightRays = ({
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      // Smart DPR calculation: Low-power clamp for mobile / low-end devices
      const isMobile = typeof window !== 'undefined' && (window.innerWidth < 768 || 'ontouchstart' in window);
      const targetDpr = isMobile ? 1 : Math.min(window.devicePixelRatio || 1, 1.25);
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const updatePlacement = () => {
        ...
        const isMob = typeof window !== 'undefined' && (window.innerWidth < 768 || 'ontouchstart' in window);
        renderer.dpr = isMob ? 1 : Math.min(window.devicePixelRatio || 1, 1.25);
